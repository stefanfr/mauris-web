...
<ul>
	...
	<li>
		...
		<ul>
			...
			<li><b><?php echo h(__('Duration in seconds'))?>:</b> <?php echo h($configuration['settings']['duration'])?></li>
			...
			<li><b><?php echo h(__('Lock'))?>:</b> <?php echo h(humanBoolean($configuration['settings']['lock']))?></li>
			<li><b><?php echo h(__('Serialize'))?>:</b> <?php echo h(humanBoolean($configuration['settings']['serialize']))?></li>
			<li><b><?php echo h(__('Windows'))?>:</b> <?php echo h(humanBoolean($configuration['settings']['isWindows']))?></li>
			<li><b><?php echo h(__('Mask'))?>:</b> <?php echo h($configuration['settings']['mask'])?></li>
			<li><b><?php echo h(__('Propability'))?>:</b> <?php echo h($configuration['settings']['probability'])?></li>
		</ul>
	</li>
</ul>