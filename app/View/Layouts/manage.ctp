...
<body>
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand"
				   href="<?= Router::url(array('plugin' => false, 'controller' => 'home', 'action' => 'index', 'manage' => true)) ?>"><?= $this->Naming->brand() ?>
					- <?= __('Manage') ?></a>
			</div>
	...
	<div class="container">	
            <? if ((!isset($hideCrumb)) || (!$hideCrumb)): ?>
	            <? $this->Html->addCrumbToBeginning(__('Manage'), array('controller' => 'home', 'action' => 'index', 'manage' => true)); ?>
