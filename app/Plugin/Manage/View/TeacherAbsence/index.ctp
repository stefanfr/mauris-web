...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-default" href="<?=Router::url(array('action' => 'edit', $absence_report['TeacherAbsenceReport']['id']))?>">
                    <span class="glyphicon glyphicon-pencil"></span>
                </a>
            </td>
            <td>
                <a class="btn btn-default" href="<?=Router::url(array('action' => 'remove', $absence_report['TeacherAbsenceReport']['id']))?>">
